    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Add a new dish to Mom's Kitchen menu.</p>
            </div>
            ...
            <div class="bg-white shadow-2xl shadow-slate-200/50 sm:rounded-3xl border border-slate-100 overflow-hidden">
                <div class="p-8 sm:p-10">
                    <form action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <!-- Section: Image Upload with Preview -->
                        <div class="pt-4 border-t border-slate-50">
                            <label class="block text-sm font-bold text-slate-700 mb-3 ml-1">Cover Image</label>
                            
                            <!-- Preview Box -->
                            <div id="preview-container" class="hidden mb-4 relative group">
                                <img id="image-preview" src="#" alt="Preview" class="w-full h-56 object-cover rounded-3xl border-4 border-white shadow-lg">
                        ...
                        <div class="pt-4 border-t border-slate-50">
                            ...
                            <div class="inline-flex p-1 bg-slate-100 rounded-2xl">
                                <label class="cursor-pointer">
                                    <input type="radio" name="availability_status" value="available" class="hidden peer" {{ old('availability_status', 'available') == 'available' ? 'checked' : '' }}>
                                ...
                                <label class="cursor-pointer">
                                    <input type="radio" name="availability_status" value="unavailable" class="hidden peer" {{ old('availability_status') == 'unavailable' ? 'checked' : '' }}>
